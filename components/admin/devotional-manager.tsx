...
export function DevotionalManager({ overrideMode, setOverrideMode }: { overrideMode?: "list" | "new", setOverrideMode?: (key: "list"|"new")=>void }) {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      {error && (
        <div className="bg-red-100 border border-red-300 text-red-600 px-3 py-2 sm:px-4 rounded-xl text-sm sm:text-base shadow-sm">
          {error}
        </div>
      )}
      {!isCreating && !editingDevotional && (
        <Card className="shadow-lg border-border/50">
          <CardHeader className="pb-4">
            <CardTitle className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">Devocionais</CardTitle>
          </CardHeader>
      ...
      {isCreating && (
        <Card className="shadow-lg border-border/50">
          <CardHeader className="pb-4">
            <CardTitle className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">Criar Novo Devocional</CardTitle>
          </CardHeader>
          <CardContent className="pt-0">
      ...
      {editingDevotional && (
        <Card className="shadow-lg border-border/50">
          <CardHeader className="pb-4">
            <CardTitle className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">Editar Devocional</CardTitle>
          </CardHeader>
          <CardContent className="pt-0">
            <DevotionalForm
